...
import com.nekta.springboot.todos.service.AdminService;
...
@Tag(name = "Admin REST API Endpoints", description = "Operation realted to a admin")
@RestController
...
public class AdminController {
    ...
    @Operation(summary = "Delete user", description = "Promote user to admin role")
